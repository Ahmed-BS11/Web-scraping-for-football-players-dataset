...
with open('DebutFin2021_2022.csv', 'w', newline='', encoding='utf8') as file:
        ...
        for num_page in range(1, 41):
                URL = f"https://www.transfermarkt.com/transfers/saisontransfers/statistik/top/plus/1/galerie/0?saison_id=2021&page="+ str(num_page)
                ...
                for i, j, k in zip(range(len(td)), range(len(a)), range(len(img))):
                        ...
                        dataheadercontent = soupp.find_all('span', class_='data-header__content')
